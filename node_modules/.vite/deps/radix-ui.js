...
var AccordionImplSingle = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return (0, import_jsx_runtime7.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React7.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React7.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React7.forwardRef((props, forwardedRef) => {
  ...
  const handleItemOpen = React7.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React7.useCallback(
...
var AccordionImpl = React7.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React7.useRef(null);
...
var AccordionTrigger = React7.forwardRef(
  (props, forwardedRef) => {
...
var AccordionContent = React7.forwardRef(
  (props, forwardedRef) => {
...
var Portal = React10.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM.createPortal((0, import_jsx_runtime10.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogContentImpl = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    return (0, import_jsx_runtime11.jsx)(import_jsx_runtime11.Fragment, { children: (0, import_jsx_runtime11.jsx)(
      FocusScope,
      {
        asChild: true,
        loop: true,
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime12.jsx)(Dialog, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogTrigger = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(DialogTrigger, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime12.jsx)(DialogPortal, { ...dialogScope, ...portalProps });
};
...
var AlertDialogOverlay = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(DialogOverlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
...
var AlertDialogContent = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime12.jsx)(
      DialogContent,
      {
        role: "alertdialog",
        ...dialogScope,
...
var AlertDialogTitle = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
...
var AlertDialogDescription = React24.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime12.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
...
var AlertDialogAction = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(DialogClose, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
...
var AlertDialogCancel = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(DialogClose, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AspectRatio = React25.forwardRef(
  (props, forwardedRef) => {
...
var Avatar = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, ...avatarProps } = props;
    const [imageLoadingStatus, setImageLoadingStatus] = React26.useState("idle");
    ...
    return (0, import_jsx_runtime14.jsx)(
      AvatarProvider,
      {
        ...
        imageCount,
        setImageCount,
        children: (0, import_jsx_runtime14.jsx)(Primitive.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    const loadingStatusRef = React26.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime14.jsx)(Primitive.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React26.useState(delayMs === void 0);
    React26.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime14.jsx)(Primitive.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageCount() {
  ...
  if (true) {
    state = React26.useState(0);
    const [imageCount] = state;
    const hasWarnedRef = React26.useRef(false);
    React26.useEffect(() => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
          ...
          isFormControl2 && (0, import_jsx_runtime15.jsx)(
            CheckboxBubbleInput,
            {
              __scopeCheckbox
            }
...
var PopperAnchor = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime17.jsx)(
      Primitive.div,
      {
...
var RovingFocusGroup = React33.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime18.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime18.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime18.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime19.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(PortalProvider2, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime19.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime19.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime19.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime19.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuSubContent = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React34.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime19.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(
      MenuContentImpl,
      {
...
var ContextMenu = (props) => {
  ...
  const hasInteractedRef = React35.useRef(false);
  if (true) {
  ...
  return (0, import_jsx_runtime20.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime20.jsx)(Root32, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
};
ContextMenu.displayName = CONTEXT_MENU_NAME;
var TRIGGER_NAME6 = "ContextMenuTrigger";
var ContextMenuTrigger = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React35.useRef({ x: 0, y: 0 });
    const virtualRef = React35.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React35.useRef(0);
    const clearLongPress = React35.useCallback(
    ...
    React35.useEffect(() => clearLongPress, [clearLongPress]);
    React35.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React35.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React35.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React35.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React35.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React35.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React35.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React35.forwardRef((props, forwardedRef) => {
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime21.jsx)(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
...
var DropdownMenuTrigger = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime21.jsx)(
      Primitive.button,
      {
        type: "button",
...
var DropdownMenuSubTrigger = React36.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime21.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
...
var Form = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React38.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React38.useState({});
    const getFieldValidity = React38.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React38.useCallback(
    ...
    const handleFieldValiditionClear = React38.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React38.useState({});
    const getFieldCustomMatcherEntries = React38.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React38.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React38.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React38.useState({});
    const getFieldCustomErrors = React38.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React38.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React38.useState({});
    const handleFieldMessageIdAdd = React38.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React38.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React38.useCallback(
...
var FormField = React38.forwardRef(
  (props, forwardedRef) => {
...
var FormLabel = React38.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React38.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React38.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormBuiltInMessage = React38.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React38.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React38.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React38.forwardRef(
  (props, forwardedRef) => {
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React39.useRef(false);
  const isPointerDownOnContentRef = React39.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React39.useCallback(() => setOpen(false), [setOpen]);
  React39.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime24.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime24.jsx)(Root25, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME8 = "HoverCardTrigger";
var HoverCardTrigger = React39.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React39.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React39.useState(false);
  React39.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React39.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React40.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React40.useState(null);
    return (0, import_jsx_runtime25.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React40.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React40.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React40.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React40.useRef(false);
...
var MenubarTrigger = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React40.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React40.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React40.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React41.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? ReactDOM3.createPortal(
...
var NavigationMenuViewportItem = ({
  ...
  const handleContentChange = React41.useCallback(
    (node) => {
      if (isActive && node) {
  ...
  return (0, import_jsx_runtime26.jsx)(NavigationMenuContentImpl, { ...props, ref: composedRefs });
};
...
var OneTimePasswordField = React42.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React42.useCallback(
      (value2) => {
    ...
    const controlledValue = React42.useMemo(() => {
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: React42.useCallback(
        (value2) => onValueChange?.(value2.join("")),
        [onValueChange]
      )
    });
    const latestValueRef = React42.useRef(value);
    latestValueRef.current = value;
    const dispatch = React42.useCallback(
      (action) => {
    ...
    const validationTypeRef = React42.useRef(validation);
    React42.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React42.useRef(null);
    const userActionRef = React42.useRef(null);
    ...
    const locateForm = React42.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React42.useCallback(() => {
    ...
    const valueRef = React42.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React42.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React42.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React42.useState(null);
  ...
  const keyboardActionTimeoutRef = React42.useRef(null);
  React42.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React43.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React43.useCallback(
  ...
  const focusState = React43.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React43.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React43.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React43.useState(void 0);
    const elementRef = React43.useRef(null);
...
var PasswordToggleFieldIcon = React43.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
// node_modules/radix-ui/node_modules/@radix-ui/react-popover/dist/index.mjs
var dist_exports27 = {};
...
function RadioProvider(props) {
  ...
  const [control, setControl] = React46.useState(null);
  const [bubbleInput, setBubbleInput] = React46.useState(null);
  ...
  return (0, import_jsx_runtime31.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME12 = "RadioTrigger";
var RadioTrigger = React46.forwardRef(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(
      RadioProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [
...
var RadioBubbleInput = React46.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React46.useRef(checked);
    return (0, import_jsx_runtime31.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroupItemBubbleInput = React210.forwardRef((props, forwardedRef) => {
  ...
  const radioScope = useRadioScope(__scopeRadioGroup);
  return (0, import_jsx_runtime32.jsx)(RadioBubbleInput, { ...radioScope, ...bubbleProps, ref: forwardedRef });
});
...
var ScrollAreaViewport = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [
      (0, import_jsx_runtime33.jsx)(ScrollAreaViewportStyle, { nonce }),
...
var ScrollAreaViewportStyle = React211.memo(
  ({ nonce }) => {
    return (0, import_jsx_runtime33.jsx)(
      "style",
      {
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React48.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React48.useCallback((option) => {
  ...
  return (0, import_jsx_runtime34.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime34.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime34.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime34.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime34.jsx)(React48.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime34.jsx)(PortalProvider5, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime34.jsx)(Portal, { asChild: true, ...portalProps }) });
};
...
var SelectContent = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime34.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime34.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME13;
var SelectContentFragment = React48.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM4.createPortal(
    (0, import_jsx_runtime34.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime34.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime34.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectArrow = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime34.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React48.forwardRef(
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime34.jsx)("option", { value: "" }) : null,
...
var Separator3 = React49.forwardRef((props, forwardedRef) => {
...
var Slider = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React50.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction4(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime36.jsx)(Collection8.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime36.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index: index2, isFormControl: isFormControl2 }) => (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
...
var SliderBubbleInput = React50.forwardRef(
...
function SwitchProvider(props) {
  ...
  const [control, setControl] = React51.useState(null);
  const [bubbleInput, setBubbleInput] = React51.useState(null);
  ...
  return (0, import_jsx_runtime37.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction5(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME14 = "SwitchTrigger";
var SwitchTrigger = React51.forwardRef(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime37.jsx)(
      SwitchProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [
...
var SwitchBubbleInput = React51.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React51.useRef(checked);
    return (0, import_jsx_runtime37.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime39.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime39.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToggleGroup = React55.forwardRef((props, forwardedRef) => {
  const { type, ...toggleGroupProps } = props;
  if (type === "single") {
    const singleProps = toggleGroupProps;
    return (0, import_jsx_runtime41.jsx)(ToggleGroupImplSingle, { role: "radiogroup", ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime41.jsx)(ToggleGroupImplMultiple, { role: "toolbar", ...multipleProps, ref: forwardedRef });
  }
  throw new Error(`Missing prop \`type\` expected on \`${TOGGLE_GROUP_NAME}\``);
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupValueProvider, useToggleGroupValueContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImplSingle = React55.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime41.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      onItemDeactivate: React55.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime41.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React55.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React55.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React55.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime41.jsx)(
...
var ToggleGroupImpl = React55.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
...
var ToggleGroupItem = React55.forwardRef(
  (props, forwardedRef) => {
...
var ToggleGroupItemImpl = React55.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime42.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime42.jsx)(ToggleGroupItem, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime43.jsx)(PortalProvider6, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime43.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime43.jsx)(Portal, { asChild: true, container, children }) }) });
};
